...
// ✅ Only products with >= 40% discount
const filteredProducts = computed(() =>
    productData.filter(p => p.p_discount && p.p_discount >= 40)
);
        ...
        <div class="w-full flex flex-col items-start">
            ...
            <div class="w-full flex flex-row items-center justify-between">
                <div class="w-fit flex flex-row items-center gap-2">
                    <span :class="[styles.main_headingText, 'font-bold']">EXCLUSIVE</span>
                    <span :class="[styles.main_headingText, 'font-light']">40% OFF</span>
                </div>
                <div class="w-fit flex flex-row items-center gap-2">
            ...
            <div class="w-full py-[4%] overflow-hidden relative">
                <div ref="carouselRef" class="w-full grid grid-cols-4 gap-6">
                    <div v-for="product in currentProducts" :key="product.id"
                        class="grid grid-cols-1 relative bg-[#FFFCFA] shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02]">
                        <CdHeart
                            ...
                            <div class="w-full h-1/2 flex flex-col gap-y-2 p-4">
                                ...
                                <div class="w-full flex flex-col">
                                    ...
                                    <div class="w-full flex flex-row items-center gap-x-2 mt-4">
                                        <span
                                            class="text-[#d94242] text-[15px] line-through font-medium font-[Inter]">LKR</span>
                                        <span class="text-[#d94242] text-[15px] line-through font-medium font-[Inter]">
                                    ...
                                    <div class="w-full flex flex-row items-center gap-x-2">
                                        ...
                                        <div class="w-full flex flex-row items-center justify-between">
                                            <span class="text-[#403A35] text-[20px] font-medium font-[Inter]">
                                                {{
                                                    (product.p_price - (product.p_price * ((product.p_discount ?? 0) /
                                                        100))).toLocaleString()
                                                }}.00
                                            </span>
                                            <CoCart
                        ...
                        <div
                            class="absolute top-2 left-2 bg-[#d23333] text-white text-[12px] font-medium px-2 py-1 rounded-md">
